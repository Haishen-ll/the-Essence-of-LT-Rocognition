...
class CosNorm_Classifier(nn.Module):
    def __init__(self, in_dims, out_dims, scale=16, margin=None, init_std=0.001):
...
class NormedLinear(nn.Module):
    ...
    def __init__(self, in_features, out_features, scale=16):
    ...
    def forward(self, x):
        out = (self.scale*F.normalize(x, dim=1)).mm(F.normalize(self.weight, dim=0))
        return out
...
def resnet44(num_classes=10):
    return ResNet_s(BasicBlock, [7, 7, 7], num_classes=num_classes)
...
def resnet110(num_classes=10):
    return ResNet_s(BasicBlock, [18, 18, 18], num_classes=num_classes)


def resnet1202(num_classes=10):
    return ResNet_s(BasicBlock, [200, 200, 200], num_classes=num_classes)
