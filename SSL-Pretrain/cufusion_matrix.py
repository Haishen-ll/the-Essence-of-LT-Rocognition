...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = models.__dict__[args.arch](num_classes=num_classes,use_norm=use_norm,return_features=False)
    ...
    train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=100, shuffle=False,
        num_workers=args.workers, pin_memory=True)
    args.confusion_title=None
    calc_confusion_mat(val_loader, model, args, './confusion','None')

def load_network(args, network):
    # filename = 'D:/code/NIPS2021/模型数据备份/model/cifar10_resnet32_CE_None_exp_0.01_original/ckpt.pth.tar'
    # filename = 'D:/code/NIPS2021/模型数据备份/model/cifar10_resnet32_CE_None_exp_0.01_pre+backbone/ckpt.pth.tar' #pretrian+resample
    #filename = 'D:/code/NIPS2021/模型数据备份/model/cifar10_resnet32_CE_Resample_exp_0.01_original/ckpt.pth.tar'
    # filename = 'D:/code/NIPS2021/模型数据备份/model/cifar10_resnet32_CE_Resample_exp_0.01_pre+backbone/ckpt.pth.tar'
    # filename = 'D:/code/NIPS2021/模型数据备份/model/cifar10_resnet32_CE_Reweight_exp_0.01_original/ckpt.pth.tar'
    # filename = 'D:/code/NIPS2021/模型数据备份/model/cifar10_resnet32_CE_Reweight_exp_0.01_pre+backbone/ckpt.pth.tar'
    # filename = 'D:/code/NIPS2021/模型数据备份/model/cifar10_resnet32_Focal_None_exp_0.01_original/ckpt.pth.tar'
    # filename = 'D:/code/NIPS2021/模型数据备份/model/cifar10_resnet32_Focal_None_exp_0.01_pre+backbone/ckpt.pth.tar'
    filename = 'D:/code/NIPS2021/模型数据备份/model/cifar10_resnet32_LDAM_None_exp_0.01_original/ckpt.pth.tar'
    # filename = 'D:/code/NIPS2021/模型数据备份/model/cifar10_resnet32_LDAM_None_exp_0.05_pre+backbone/ckpt.pth.tar'
